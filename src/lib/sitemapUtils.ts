 ...
 *   /sitemaps/core-pages.xml        → Homepage, about, contact, portfolio, locations, services index
...
/** Core static pages — homepage, about, services index, portfolio, locations, contact */
