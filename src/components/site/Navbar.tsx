    ...
    <header className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${scrolled ? "glass py-2.5" : "py-4"}`}>
      <nav className="container flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3">
          ...
          <span className="font-semibold tracking-tight text-base md:text-lg leading-tight">
            Silver Wolf<br className="hidden md:block" />
            <span className="text-gradient md:text-sm font-medium tracking-[0.18em] uppercase">Technologies</span>
          </span>
        </Link>
